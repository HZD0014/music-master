...
public class Playing_music extends AppCompatActivity implements View.OnClickListener,SeekBar.OnSeekBarChangeListener {
    ...
    List<allSongs_json.ResultBean.SongsBean> music_list;
...
//    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // Log.d("#artist",artist);
        ...
        my_artist=artist;
        String music_url="http://music.eleuu.com/song/url?id="+music_id;
    ...
    private void setPlayMode(){
        if(playAgagin==0){
            ...
            if(position==music_list.size()-1){
                ...
                needle.setAnimation(rotateAnimation2);
                String music_url="http://music.eleuu.com/song/url?id="+music_list.get(position).getId();
                HttpUtil.sendOkHttpRequest(music_url, new Callback() {
                    @Override
                    public void onFailure(Call call, IOException e) {
                        Looper.prepare();
